...
import com.example.kwako.ImageUploadViewHolder;
import com.example.kwako.Item;
...
public class ImageUploadAdapter extends RecyclerView.Adapter<ImageUploadViewHolder> {
    ...
    public ImageUploadViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ImageUploadViewHolder(LayoutInflater.from(context).inflate(R.layout.activity_image_upload_item,parent,false));
    }
